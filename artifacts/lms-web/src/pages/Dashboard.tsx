                ...
                <div key={enrollment.id} className="bg-card rounded-2xl border border-border overflow-hidden shadow-sm flex flex-col hover:shadow-md transition-shadow">
                  <div className="aspect-video bg-muted relative overflow-hidden">
                    ...
                    {isExpired ? (
                      ...
                      <div className="absolute top-2 end-2 bg-warning/100 text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow">
                ...
                <div key={session.id} className="bg-card rounded-2xl border border-border p-5 shadow-sm flex flex-col hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`text-xs px-2.5 py-1 rounded-full font-bold ml-3 ${
                      session.status === 'live' ? 'bg-destructive/100 text-white animate-pulse' : 'bg-info/10 text-info'
                    }`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {!enrolled ? (
          <div className="text-center py-20 bg-card rounded-3xl border border-dashed border-amber-500/30">
            ...
            {hasPendingApp ? (
              <>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-info/10 text-info text-xs font-bold mb-4">
              ...
              <>
                ...
                <div className="flex gap-4 justify-center">
                  <Link href="/academy">
                    <Button variant="outline" className="font-bold rounded-xl border-amber-500/30 text-warning hover:bg-warning/10">Learn More</Button>
                  </Link>
          ...
          <div className="bg-card rounded-3xl border border-border p-8 shadow-sm">
             <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8 pb-8 border-b border-border">
               ...
               <Link href="/academy/dashboard">
                 <Button className="bg-warning/100 hover:bg-warning/90 text-white rounded-xl font-bold px-6 shadow-md shadow-amber-500/20 w-full sm:w-auto">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
               {current?.registrations?.slice(0, 3).map((reg: any) => (
                 <div key={reg.id} className="border border-border rounded-xl p-4 flex items-center justify-between hover:bg-muted/50 transition-colors">
                   ...
                   <span className="text-xs font-bold text-warning bg-warning/10 px-2 py-1 rounded">
