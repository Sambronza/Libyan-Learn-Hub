    ...
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden border border-border/60 bg-card shadow-2xl">
                <div className="h-64 bg-gradient-to-br from-primary to-violet-600 relative">
      ...
      <section className="py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            {...fadeUp()}
            className="relative overflow-hidden rounded-[2rem] lg:rounded-[3rem] bg-gradient-to-br from-primary to-violet-600 p-8 sm:p-10 lg:p-12 text-center text-white"
          >
